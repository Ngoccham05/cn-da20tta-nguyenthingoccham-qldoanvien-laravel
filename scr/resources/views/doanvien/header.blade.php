        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="{{ $currentPath == 'ktcn/cddanhgia' ? 'active' : '' }}"><a href="/ktcn/cddanhgia"><i class="menu-icon fa fa-check"></i>Chi đoàn tự đánh giá</a></li>
                    @endif
                    ...
                    <li class="{{ $currentPath == 'ktcn/doanvien' || $currentPath == 'ktcn/dvchidoan' ? 'active' : '' }}"><a href="/ktcn/doanvien"><i class="menu-icon fa fa-users"></i>Danh sách đoàn viên</a></li>
                    ...
                    <li class="{{ $currentPath == 'ktcn/danhgiacd' || $currentPath == 'ktcn/dgchidoan' ? 'active' : '' }}"><a href="/ktcn/danhgiacd"><i class="menu-icon fa fa-check-square"></i>Đánh giá chi đoàn</a></li>
                    <li class="{{ $currentPath == 'ktcn/danhgiadv' ? 'active' : '' }}"><a href="/ktcn/danhgiadv"><i class="menu-icon fa fa-check-square-o"></i>Đánh giá đoàn viên</a></li>
                    @endif
                </ul>
            </div><!-- /.navbar-collapse -->
